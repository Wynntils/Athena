...
data class FileTable(
    ...
    fun load() {
        ...
        profile("FileCabinet-FileTable-Load", false) { // performance profiling
    ...
    fun getFile(name: String): FileReference? {
        ...
        return profile("FileCabinet-FileTable-Get") {
    ...
    fun insertFile(name: String, data: ByteArray? = null, overlap: Boolean = false): ActionResult {
        ...
        profile("FileCabinet-FileTable-Insert", false) { // performance profiling
    ...
    fun totalSize(): Long {
        ...
        profile("FileCabinet-FileTable-TotalSize", false) { // performance profiling
