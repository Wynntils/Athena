...
object GuildManager {
    ...
    private fun generateGuildData(name: String?): Guilds? {
        ...
        val profile = Guilds(name, input["prefix"] as String)
        profile.asyncSave()
